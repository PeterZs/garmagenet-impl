...
class SurfZData(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        self.data_list = [os.path.basename(x) for x in self.data_list if os.path.exists(os.path.join(self.data_root, os.path.basename(x)))]
