...
class PointNet2PTMSGDynamic_2(nn.Module):
    """
    2025 07 02, 大量减少了KNN算法的感受范围
    """
    def __init__(
            self,
            feat_in=3, feat_out=2,
            nsample_list=[[16, 32], [16, 32], [16, 32], [16, 32]],
            ratio_list=[0.15, 0.25, 0.25, 0.25]
    ):
        super().__init__()
        self.feat_in = feat_in
        self.feat_out = feat_out
        ...
        self.sa1 = PointNetSetAbstractionMsgDynamic(ratio_list[0], [0.05, 0.1], self.nsample_list[0], self.feat_in,
                                                    [[16, 16, 32], [32, 32, 64]])
        self.sa2 = PointNetSetAbstractionMsgDynamic(ratio_list[1], [0.1, 0.2], self.nsample_list[1], 32 + 64, [[64, 64, 128], [64, 96, 128]])
        self.sa3 = PointNetSetAbstractionMsgDynamic(ratio_list[2], [0.2, 0.4], self.nsample_list[2], 128 + 128,
                                                    [[128, 196, 256], [128, 196, 256]])
        self.sa4 = PointNetSetAbstractionMsgDynamic(ratio_list[3], [0.4, 0.8], self.nsample_list[3], 256 + 256,
                                                    [[256, 256, 512], [256, 384, 512]])
        self.fp4 = PointNetFeaturePropagationDynamic(512 + 512 + 256 + 256, [256, 256])
        self.fp3 = PointNetFeaturePropagationDynamic(128 + 128 + 256, [256, 256])
        self.fp2 = PointNetFeaturePropagationDynamic(32 + 64 + 256, [256, 128])
...
if __name__ == '__main__':
    ...
    model_point = PointNet2PTMSGDynamic_2(3, 128)
